...
-- Dumping database structure for akurugoda_cashier
CREATE DATABASE IF NOT EXISTS `akurugoda_cashier` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `akurugoda_cashier`;

-- Dumping structure for table akurugoda_cashier.brand
...
-- Dumping structure for table akurugoda_cashier.company
...
-- Dumping structure for table akurugoda_cashier.customer
...
-- Dumping structure for table akurugoda_cashier.employee
...
-- Dumping structure for table akurugoda_cashier.employee_history
...
-- Dumping structure for table akurugoda_cashier.grn
CREATE TABLE IF NOT EXISTS `grn` (
  ...
  CONSTRAINT `FK_grn_supplier` FOREIGN KEY (`supplier_mobile`) REFERENCES `supplier` (`mobile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Data exporting was unselected.

-- Dumping structure for table akurugoda_cashier.grn_history_item
...
-- Dumping structure for table akurugoda_cashier.grn_item
...
-- Dumping structure for table akurugoda_cashier.invoice
...
-- Dumping structure for table akurugoda_cashier.invoice_history_item
...
-- Dumping structure for table akurugoda_cashier.invoice_item
...
-- Dumping structure for table akurugoda_cashier.product
...
-- Dumping structure for table akurugoda_cashier.status
...
-- Dumping structure for table akurugoda_cashier.supplier
