...
public class Grn extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel23.setLayout(new java.awt.BorderLayout(0, 5));
        ...
        jButton19.setText("Select supplier");
        jButton19.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButton19.setPreferredSize(new java.awt.Dimension(155, 40));
        jButton19.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton19ActionPerformed(evt);
            }
        });
        jPanel6.add(jButton19, java.awt.BorderLayout.CENTER);

        jButton20.setBackground(new java.awt.Color(0, 153, 255));
        jButton20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/reload1.png"))); // NOI18N
        jButton20.setPreferredSize(new java.awt.Dimension(45, 40));
        jPanel6.add(jButton20, java.awt.BorderLayout.EAST);

        jPanel23.add(jPanel6, java.awt.BorderLayout.PAGE_START);
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(600, 124));
        ...
        jPanel1.add(jLabel44, java.awt.BorderLayout.WEST);
        ...
        jPanel1.add(jTextField14, java.awt.BorderLayout.CENTER);

        jPanel4.add(jPanel1, java.awt.BorderLayout.CENTER);

        jPanel2.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 10, 0, 0));
        jPanel2.setPreferredSize(new java.awt.Dimension(300, 45));
        jPanel2.setLayout(new java.awt.BorderLayout());

        jLabel40.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel40.setText("S. Name");
        jLabel40.setPreferredSize(new java.awt.Dimension(70, 0));
        jPanel2.add(jLabel40, java.awt.BorderLayout.WEST);

        jTextField12.setEditable(false);
        jTextField12.setFont(new java.awt.Font("Iskoola Pota", 0, 18)); // NOI18N
        jTextField12.setPreferredSize(new java.awt.Dimension(220, 22));
        jPanel2.add(jTextField12, java.awt.BorderLayout.CENTER);

        jPanel4.add(jPanel2, java.awt.BorderLayout.EAST);

        jPanel60.add(jPanel4, java.awt.BorderLayout.EAST);
...
//            System.out.println(String.valueOf(mfg));
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try {
            ...
            String supplierMobile = jTextField14.getText();
            ...
            if (paidAmount.isEmpty()) {
                ...
                double x = Double.parseDouble(jLabel32.getText());

                if (x < 0) {

                    MySQL.execute("UPDATE `supplier` SET `balance_amount`='" + jLabel32.getText() + "', `last_update_time`='" + getCurrentDateTime() + "'  WHERE `mobile`='" + supplierMobile + "' ");

                } else {

                    MySQL.execute("UPDATE `supplier` SET `balance_amount`='0', `last_update_time`='" + getCurrentDateTime() + "' WHERE `mobile`='" + supplierMobile + "' ");;

                }

                MySQL.execute("INSERT INTO `grn`(`id`,`supplier_mobile`,`employee_email`,`date_time`,`paid_amount`,`last_update_time`)"
                        + " VALUES('" + grnNumber + "','" + supplierMobile + "','" + employeeEmail + "'"
